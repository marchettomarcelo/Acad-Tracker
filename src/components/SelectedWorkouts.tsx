...
function SelectedWorkouts({
  ...
  return (
    <>
      <button onClick={() => console.log(status)}>ver</button>
        ...
        <div className="flex w-full flex-col items-center justify-center">
          {workOut ? (
            <button
              ...
              className="group relative mb-2 mr-2 inline-flex items-center justify-center overflow-hidden rounded-lg bg-gradient-to-br from-orange-300 to-red-300 p-0.5 text-lg font-medium  "
            >
